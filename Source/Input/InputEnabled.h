...
public:
	...
	virtual void handle_mouse_press(int button, int action, int mods, double delta_time, bool captured) { return; };
	virtual void handle_mouse_entered(int entered, double delta_time, bool captured) { return; }
	virtual void handle_mouse_movement(double x, double y, double delta_x, double delta_y, double delta_time, bool captured) { return; }
